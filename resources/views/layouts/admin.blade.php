    ...
    <div id="admin_page" class="wrapper">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto flex-fill">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{route('configuration')}}">Configuration</a>
                                </div>
                            </li>
        ...
        <footer class="m-footer pl-3 pr-3">
            <strong>Copyright &copy; 2014- <script>
                ...
                </script> <a href="https://nphl.go.ke/">NPHL KNEQAS -Microbiology PT</a>.</strong>
            All rights reserved. | <a href="http://helpdesk.nphl.go.ke/">KNEQAS Microbiology PT HELP DESK</a>
