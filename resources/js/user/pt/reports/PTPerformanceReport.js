...
class PTPerformanceReport extends React.Component {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <ReactToPrint
                    documentTitle={"Microbiology HPV PT Report"}
                    ...
                    <tbody >
                        ...
                        <tr style={{ "fontWeight": "bold" }} >
                            <td style={{ "lineHeight": "8px" }} colSpan={totalTableLength}>
                                ...
                                <p>NATIONAL Microbiology REFERENCE LABORATORY</p>
                        ...
                        <tr>
                            <td style={paragraphStyle} colSpan={totalTableLength}>
                                ...
                                <ol className="report">
                                    <li>MICROBIOLOGY HPV PT is a qualitative scheme.</li>
                        ...
                        <tr style={{ "fontWeight": "bold" }} >
                            <td style={paragraphStyle} colSpan={totalTableLength}>
                                ...
                                <p>MICROBIOLOGY HPV Proficiency Testing</p>
                            </td>
                        </tr>
                        <tr style={{ "fontWeight": "bold" }} >
                            <td style={paragraphStyle} colSpan={totalTableLength}>
                                <p>KNEQAS QA: Charity Maina</p>
                                <p>MICROBIOLOGY SCOPE Coordinator: Francis Tawuo</p>
                            </td>
                        </tr>
                        <tr><p></p></tr>
                        <tr>
